...
def bookmark_list(request):
    ...
    return render(request, 'marcad/bookmark_list.html', context) 
...
def bookmark_user(request, username):
    ...
    return render(request, 'marcad/bookmark_user.html', context) 
...
def bookmark_create(request):
    ...
    return render(request, 'marcad/form.html', context) 
